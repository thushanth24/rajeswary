...
const routes = [
  ...
  { path: "/halls/raajeshwariygroups-kondavil", changefreq: "weekly", priority: "0.8" },
  { path: "/halls/raajeshwariygroups-tellipalai", changefreq: "weekly", priority: "0.8" },
  { path: "/halls/chelva-palace", changefreq: "weekly", priority: "0.8" },
  { path: "/halls/chelva-mahal", changefreq: "weekly", priority: "0.8" },
  { path: "/halls/karpaka-raajeshwariygroups", changefreq: "weekly", priority: "0.8" },
  { path: "/halls/urumpirai", changefreq: "weekly", priority: "0.8" },
];
