...
function categorizeItems(items: string[]): Record<string, string[]> {
  ...
  items.forEach((item) => {
    ...
    if (lowerItem.includes("starter") || lowerItem.includes("drink") || lowerItem.includes("juice") || lowerItem.includes("cake") || lowerItem.includes("laddu") || lowerItem.includes("patties") || lowerItem.includes("roll") || lowerItem.includes("ஸ்டார்டர்") || lowerItem.includes("பானம்") || lowerItem.includes("லட்டு") || lowerItem.includes("கேக்") || lowerItem.includes("பட்டீஸ்") || lowerItem.includes("ஃபலூடா")) {
      categories["Starters"].push(item);
    } else if (lowerItem.includes("rice") || lowerItem.includes("soru") || lowerItem.includes("biriyani") || lowerItem.includes("saadam") || lowerItem.includes("noodles") || lowerItem.includes("idiyappa") || lowerItem.includes("kothu") || lowerItem.includes("puttu") || lowerItem.includes("சாதம்") || lowerItem.includes("சோறு") || lowerItem.includes("பிரியாணி") || lowerItem.includes("நூடுல்ஸ்") || lowerItem.includes("இடியப்ப") || lowerItem.includes("கொத்து")) {
      categories["Rice & Mains"].push(item);
    } else if (lowerItem.includes("kari") || lowerItem.includes("curry") || lowerItem.includes("kuzhambu") || lowerItem.includes("masala") || lowerItem.includes("deval") || lowerItem.includes("moyu") || lowerItem.includes("kozhi") || lowerItem.includes("aattu") || lowerItem.includes("iraal") || lowerItem.includes("kanavai") || lowerItem.includes("கறி") || lowerItem.includes("குழம்பு") || lowerItem.includes("மசாலா") || lowerItem.includes("தேவல்") || lowerItem.includes("மோயு") || lowerItem.includes("மோஜோ") || lowerItem.includes("கோழி") || lowerItem.includes("ஆட்டு") || lowerItem.includes("இறால்") || lowerItem.includes("கணவாய்") || lowerItem.includes("இறைச்சி")) {
      categories["Curries"].push(item);
    } else if (lowerItem.includes("vadai") || lowerItem.includes("appalam") || lowerItem.includes("poriyal") || lowerItem.includes("sambal") || lowerItem.includes("salad") || lowerItem.includes("raitha") || lowerItem.includes("thayir") || lowerItem.includes("rasam") || lowerItem.includes("muttai") || lowerItem.includes("cutlet") || lowerItem.includes("chutney") || lowerItem.includes("வடை") || lowerItem.includes("அப்பளம்") || lowerItem.includes("பொரியல்") || lowerItem.includes("சம்பல்") || lowerItem.includes("சாலட்") || lowerItem.includes("ரைதா") || lowerItem.includes("தயிர்") || lowerItem.includes("ரசம்") || lowerItem.includes("முட்டை") || lowerItem.includes("கட்லெட்") || lowerItem.includes("சட்னி") || lowerItem.includes("துணை") || lowerItem.includes("மேலதிகமானவை")) {
      categories["Side Dishes"].push(item);
    } else if (lowerItem.includes("dessert") || lowerItem.includes("ice cream") || lowerItem.includes("paayaasam") || lowerItem.includes("jelly") || lowerItem.includes("pudding") || lowerItem.includes("fruit") || lowerItem.includes("pazha") || lowerItem.includes("இனிப்பு") || lowerItem.includes("ஐஸ் கிரீம்") || lowerItem.includes("பாயாசம்") || lowerItem.includes("ஜெல்லி") || lowerItem.includes("புட்டிங்") || lowerItem.includes("பழ")) {
